...
import {
    ...
    TPS_VALUES, NOTE_KEYS, SCALE_DISPLAY, DELAY_LABELS,
    fmtSign, fmtStretch, fmtLen, fmtLgto, fmtRes, fmtPct, fmtNote, fmtPages,
    fmtDly, fmtBool, fmtPlain, fmtGateMod,
...
import { drumPadToLane, drumPadToVelZone, drumVelZoneToVelocity, _clipIsEmpty, clipHasContent,
    bankCyclePos, scaleNudgeNote } from './ui_pure.mjs';
...
/* stays resident until Phase 6 (calls refreshDrumLaneBankParams), logically ui_drummodel */
 ...
 * modules (see ui_seams.mjs). IOUs: applyTrackConfig → Phase-6 ui_dsp_bridge;
 * xposePreviewSet, openTapTempo → Phase-5b/record module. */
R.applyTrackConfig = applyTrackConfig;
