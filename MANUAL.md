...
<img src="docs/working/img/step-editor.png" width="384" alt="Note edit screen: a note box on the left, then knobs for length, velocity, nudge, and per-step conditions">
...
<img src="docs/working/img/bank-conductor-octave.png" width="384" alt="C-OCTAVE bank: a per-track octave value for each of the eight tracks">
...
<img src="docs/working/img/bank-clip.png" width="384" alt="CLIP bank: resolution, stretch, shift, legato, input quantize, direction, follow">
...
<img src="docs/working/img/bank-drumlane.png" width="384" alt="DRUM LANE bank: resolution, stretch, shift, legato, euclid, direction, follow">
...
<img src="docs/working/img/bank-alllanes.png" width="384" alt="ALL LANES bank: apply resolution, stretch, shift, quantize, velocity, input quantize, direction, and repeat sync to all lanes">
...
<img src="docs/working/img/bank-notefx.png" width="384" alt="NOTE FX bank: octave, offset, velocity, quantize, length, gate, random">
...
<img src="docs/working/img/bank-drum-notefx.png" width="384" alt="NOTE FX on a drum track: knobs 1 and 2 set the lane's MIDI note">
...
<img src="docs/working/img/bank-harmony.png" width="384" alt="HARMONY bank: an octave voice and three harmony voices">
...
<img src="docs/working/img/bank-delay.png" width="384" alt="DELAY bank: rate, level, repeats, velocity feedback, pitch feedback, gate, retrigger, random">
...
<img src="docs/working/img/bank-seqarp.png" width="384" alt="SEQ ARP bank: style, rate, octave, gate, steps mode, retrigger, sync">
...
<img src="docs/working/img/bank-livearp.png" width="384" alt="LIVE ARP bank: the same controls as SEQ ARP plus a latch">
...
<img src="docs/working/img/bank-repeatgroove.png" width="384" alt="REPEAT GROOVE bank: a velocity bar for each of the eight gate-mask steps">
...
<img src="docs/working/img/bank-auto.png" width="384" alt="AUTOMATION bank: eight lanes labelled with CC, AT, and Sch targets, and a curve with a playhead">
...
<img src="docs/working/img/view-perf.png" width="384" alt="Performance Mode screen: the active mods listed, with Hold, Sync, and Latch chips and the rate">
...
<img src="docs/working/img/dialog-confirm.png" width="384" alt="Incompatible State confirm dialog with No and Yes buttons">
