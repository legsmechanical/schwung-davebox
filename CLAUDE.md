...
1. **Drum mode (in progress)** — core complete; remaining: per-lane mute/solo, DRUM SEQ bank (per-lane length/resolution knobs), live recording, mode-switch confirmation dialog.
